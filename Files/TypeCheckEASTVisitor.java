...
public class TypeCheckEASTVisitor extends BaseEASTVisitor<TypeNode,TypeException> {
	...
	//Controlla che il tipo sia una funzione
	//Controlla che gli argomenti passati al callNode
	//contenuti come argList dell'oggetto coombacino con quelli della signature nell'arrowTypeNode
	@Override
	...
	public TypeNode visitNode(NewNode n) throws TypeException {
		...
		if ( !(t.allFields.size() == n.fields.size()) )
		...
		return new RefTypeNode(n.id_class);
	}
